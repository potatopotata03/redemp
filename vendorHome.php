...
<div class="container">
	...
	<p>Start adding products into your product list and look out for customer's requests</p>
	<a href="vendorExplore.php" class="btn">Products</a>
	<a href="vendorRequest.php" class="btn">Requests</a>
	<a href="contactVendor.php" class="btn">Contact Us</a>
	<a href="vendorDetail.php" class="btn">Profile</a>
	<a href="logoutConfirmVendor.php" class="btn">Logout</a>
