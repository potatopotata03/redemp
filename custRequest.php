...
if(isset($_POST['conRequest'])){
  ...
  $result = mysqli_query($con, "INSERT INTO request (reqID, dateRequest, custUser, custFirstName, custLastName, contactNum, address1, postcode, city, country, itemID, vendorUser)
  VALUE (NULL,'$dateRequest','$custUser', '$custFirstName', '$custLastName', '$contactNum', '$address', '$postcode', '$city', '$country', '$itemID', '$vendorUser')");
}

$sql= "SELECT * FROM request WHERE custUser = '$custUser'";
//var_dump($sql);
...
<a href="cancelRequest.php?reqID=<?php echo $row['reqID'];?>" class="btn">Cancel Request</a>
<br>
<br>
<?php
  }
